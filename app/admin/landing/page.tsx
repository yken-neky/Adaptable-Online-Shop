...
export default function LandingAdminPage() {
  ...
  const addSection = () => {
    ...
    setLandingData({
      ...landingData,
      sections: [...landingData.sections, newSection],
    });
  };
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setLandingData({ ...landingData, companyName: e.target.value })
                  }
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setLandingData({ ...landingData, companyDescription: e.target.value })
                  }
                  rows={3}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md"
                />
                      ...
                      <div className="flex-1">
                        <select
                          ...
                          onChange={(e) =>
                            updateSection(section.id, {
                              type: e.target.value as LandingSection["type"],
                            })
                          }
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <input
                            ...
                            value={section.order}
                            onChange={(e) =>
                              updateSection(section.id, { order: parseInt(e.target.value) || 0 })
                            }
